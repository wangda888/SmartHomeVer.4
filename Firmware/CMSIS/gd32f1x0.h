...
#define __GD32F1x0_STDPERIPH_VERSION_SUB2   (0x01) /*!< [15:8]  sub2 version */
...
#define  RCC_AHBRCR_PDRST                    ((uint32_t)0x00100000)         /*!< GPIOD clock reset */
#define  RCC_AHBRCR_PFRST                    ((uint32_t)0x00400000)         /*!< GPIOF clock reset */
#define  RCC_AHBRCR_TSIRST                   ((uint32_t)0x01000000)         /*!< TSI clock reset   */
